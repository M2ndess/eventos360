                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link act" aria-current="page" href="/eventos360/pages/home.php">Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/eventos360/pages/profile.php">Perfil</a>
                            </li>
                        </ul>
                        <a href="/eventos360/scripts/logout.php" class="btn btn-join-now">Sair</a>
                    </div>
                </div>
            </nav>